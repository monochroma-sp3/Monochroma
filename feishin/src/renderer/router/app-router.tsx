...
const DownloadRoute = lazy(
    () => import('/@/renderer/features/monochroma/routes/download-route'),
);

const AboutRoute = lazy(() => import('/@/renderer/features/monochroma/routes/about-route'));

const DonateRoute = lazy(() => import('/@/renderer/features/monochroma/routes/donate-route'));

const ImportRoute = lazy(() => import('/@/renderer/features/monochroma/routes/import-route'));

const SocialsRoute = lazy(() => import('/@/renderer/features/monochroma/routes/socials-route'));
                                ...
                                <Route element={<AppOutlet />}>
                                    <Route element={<ResponsiveLayout />}>
                                        ...
                                        <Route
                                            ...
                                            path={AppRoute.MONOCHROMA_DOWNLOAD}
                                        />
                                        <Route
                                            element={<AboutRoute />}
                                            path={AppRoute.MONOCHROMA_ABOUT}
                                        />
                                        <Route
                                            element={<DonateRoute />}
                                            path={AppRoute.MONOCHROMA_DONATE}
                                        />
                                        <Route
                                            element={<ImportRoute />}
                                            path={AppRoute.MONOCHROMA_IMPORT}
                                        />
                                        <Route
                                            element={<SocialsRoute />}
                                            path={AppRoute.MONOCHROMA_SOCIALS}
                                        />
