export enum AppRoute {
    ...
    SERVERS = '/servers',
    SETTINGS = '/settings',
    MONOCHROMA_ABOUT = '/monochroma/about',
    MONOCHROMA_DONATE = '/monochroma/donate',
    MONOCHROMA_DOWNLOAD = '/monochroma/download',
    MONOCHROMA_IMPORT = '/monochroma/import',
    MONOCHROMA_SOCIALS = '/monochroma/socials',
}
